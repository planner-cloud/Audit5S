...
class Audit(models.Model):
    ...
    tauxRespect = models.FloatField()
    tauxMin = models.IntegerField(validators=[MinValueValidator(0),MaxValueValidator(100)])
    zone = models.ForeignKey(Zone,on_delete=models.CASCADE)
    
    auditeur = models.ForeignKey(User,on_delete=models.CASCADE)

    def __str__(self):
        return " Audit realisé en  " + str(self.date) +"  sur  %s  " % self.zone.nom

...
class AuditUserWritePermission(BasePermission):
    message = 'Editing audits/actions is restricted to his own auditeur only.'
...
class AuditUserCreatePermission(BasePermission):
    message = 'Creating audits/actions is restricted to auditeurs only.'
...
class UserWritePermission(BasePermission):
    message = 'creating  zones/categories/standards is restricted to admin only.'
...
#afficher/creer/modifier les actions d'un audit
...
class ActionList(generics.ListCreateAPIView,AuditUserCreatePermission):
...
#afficher tous les zones
class ZoneList(generics.ListCreateAPIView):
    queryset = Zone.objects.all()
    serializer_class = ZoneSerializer
    permission_classes = [UserWritePermission]
    authentication_classes=(TokenAuthentication,)
#afficher/modifier/creer/modifier une zone
...
#afficher/changer/supprimer le responsable d'une zone
